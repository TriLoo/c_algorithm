...
public:
    ...
    {
        Sophus::SE3 up(Sophus::SO3(update[3], update[4], update[5]),
...
public:
    ...
    virtual void computeError()    // 式11.3
    {
...
int main(int argc, char **argv)
{
    ...
    if (argc != 2)
    {
        cout << "Usage: PoseGraphSE3 sphere.g2o" << endl;
        return 1;
    }
    ifstream fin(argv[1]);
    if (!fin)
    ...
    typedef g2o::BlockSolver<g2o::BlockSolverTraits<6, 6>> Block;    // Block为6 * 6
